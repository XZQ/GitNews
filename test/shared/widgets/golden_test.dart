...
*/
void main() {
  Future<void> pumpScene(WidgetTester tester, Widget child, {required Type finderType}) async {
  ...
  group('Windows golden baselines', () {
    ...
    testWidgets('RepoTile golden', (tester) async {
      ...
      await expectLater(find.byType(RepoTile), matchesGoldenFile('goldens/repo_tile.png'));
    });
