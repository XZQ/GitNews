...
void main() {
  group('JsonSnapshotCacheDao', () {
    ...
    setUp(() async {
      ...
      dao = JsonSnapshotCacheDao(db.executor, CacheMetaDao(db.executor));
    });
  ...
  group('JsonSnapshotCacheDao ETag', () {
    ...
    test('validated snapshot stores Last-Modified with payload', () async {
      await dao.upsertWithValidators(
        ...
        validators: const HttpCacheValidators(etag: 'W/"feed"', lastModified: 'Sat, 18 Jul 2026 04:47:25 GMT'),
