...
void main() {
  group('normalizeAiNewsUrl', () {
    test('strips tracking params, fragment and trailing slash', () {
      expect(
        normalizeAiNewsUrl('https://Example.com/Path/?utm_source=x&ref=y&a=1#frag'),
    ...
    test('keeps meaningful query params', () {
      expect(
        normalizeAiNewsUrl('https://example.com/p?id=42'),
  ...
  group('normalizeAiNewsTitle', () {
    test('lowercases and keeps alphanumerics and CJK', () {
      expect(
        normalizeAiNewsTitle('GPT-5 发布: Hello, World!'),
        'gpt5发布helloworld',
      );
    });
  ...
  group('mergeAiNewsItems', () {
    test('primary wins over rss duplicates by url', () {
      final primary = [
        item('p1', title: '主源标题一二三四', url: 'https://example.com/a?utm_source=feed'),
      ];
      final rss = [
        item('r1', titleEn: 'Different Title Here', url: 'https://example.com/a/'),
        item('r2', titleEn: 'Unique RSS Item Here', url: 'https://example.com/b'),
      ];
    ...
    test('dedups by normalized title across sources', () {
      final primary = [
        item('p1', titleEn: 'OpenAI Releases GPT-5', url: 'https://a.com/1'),
      ];
      final rss = [
        item('r1', titleEn: 'OpenAI releases GPT-5!', url: 'https://b.com/2'),
      ];
      final merged = mergeAiNewsItems(primary: primary, extras: [rss]);
    ...
    test('sorts by publishedAt desc', () {
      final merged = mergeAiNewsItems(
        primary: [
          item('old', titleEn: 'Old Item Title Here', url: 'https://a.com/old', publishedAt: DateTime.utc(2026, 7, 10)),
        ],
        extras: [
          [
