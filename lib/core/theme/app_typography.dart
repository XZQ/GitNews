...
class AppTypography {
  ...
  // 资讯阅读稿的跨平台中文字体回退链。
  static const List<String> readingFallback = <String>['Noto Sans CJK SC', 'Microsoft YaHei', 'PingFang SC', 'sans-serif'];

  // 等宽字体族名,需与 pubspec.yaml 的 fonts.family 一致。
  static const String monoFamily = 'JetBrainsMono';

  // 等宽回退链:资源未打包时按序回退到各平台自带等宽字体。
  static const List<String> monoFallback = <String>['JetBrains Mono', 'SFMono-Regular', 'Cascadia Mono', 'Consolas', 'Menlo', 'DejaVu Sans Mono', 'monospace'];
  ...
  static TextStyle reading(TextStyle base) {
    return base.copyWith(fontFamily: readingFamily, fontFamilyFallback: readingFallback);
  }
