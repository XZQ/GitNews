          ...
          for (final contributor in contributors)
            ListTile(
              ...
              leading: CircleAvatar(
                radius: 16,
                backgroundColor: Color(contributor.avatarAccentArgb).withValues(alpha: 0.16),
                child: Text(contributor.login[0].toUpperCase(), style: AppTypography.titleSmall.copyWith(color: Color(contributor.avatarAccentArgb))),
              ),
              title: Text(contributor.login, style: AppTypography.titleSmall),
              subtitle: Text(l10n.tr('project.activity.contrib').replaceAll('{n}', contributor.contributions.toString())),
