...
class _MobileRepoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverPadding(
      ...
      sliver: SliverToBoxAdapter(
        child: SectionHeader(title: l10n.tr(titleKey), subtitle: l10n.tr(subtitleKey)),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return SliverPadding(
      ...
      sliver: SliverList.separated(
        ...
        itemBuilder: (context, i) => RepoTile(repo: repos[i], rank: ranked ? i + 1 : null, dense: true, onTap: () => context.go('/project/detail/${Uri.encodeComponent(repos[i].fullName)}')),
      ),
    );
  }
}
