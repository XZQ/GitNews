    ...
    return CustomScrollView(
      slivers: [
        ...
        SliverPadding(
          ...
          sliver: SliverToBoxAdapter(child: TrendingTopicsPanel(topics: digest.topics)),
        ),
      ],
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton(onPressed: () => Navigator.of(sheetCtx).pop(), child: Text(l10n.tr('common.done'))),
                ),
              ],
            ),
          ),
