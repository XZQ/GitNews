...
class AiNewsCategoryNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: 52,
      decoration: BoxDecoration(color: theme.colorScheme.surface, border: Border(bottom: BorderSide(color: theme.colorScheme.outlineVariant, width: 1))),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: bg,
            border: Border.all(color: isSelected ? color.withValues(alpha: 0.45) : theme.colorScheme.outlineVariant),
            borderRadius: BorderRadius.circular(AppRadius.pill),
          ),
          child: Row(
