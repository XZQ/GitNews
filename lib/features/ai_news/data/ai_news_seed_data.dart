...
class AiNewsSeedData {
  ...
  static final List<AiNewsItem> items = [
    AiNewsItem(
      ...
      summary:
          '头部模型在长上下文、视觉理解与函数调用上持续迭代,应用层开始围绕 Agent 工作流重构。',
      source: 'GitHub News',
    ...
    AiNewsItem(
      ...
      summary:
          'Cursor、Windsurf 与开源 coding agent 持续迭代,代码工作流正在从行级补全转向多文件任务代理。',
      source: 'GitHub News',
      url: 'https://github.com',
      permalink: 'https://github.com',
      publishedAt: _now,
    ...
    AiNewsItem(
      ...
      summary:
          '检索、重排、评测和知识库同步成为企业 AI 落地的基础设施,简单 demo 正在让位于工程化链路。',
      source: 'GitHub News',
      url: 'https://github.com',
      permalink: 'https://github.com',
      publishedAt: _now,
    ...
    AiNewsItem(
      ...
      summary:
          'MCP 把模型、数据源与本地应用用统一接口连接起来,生态项目与脚手架增长明显。',
      source: 'GitHub News',
      url: 'https://github.com',
      permalink: 'https://github.com',
      publishedAt: _now,
    ...
    AiNewsItem(
      ...
      summary:
          'Ollama、llama.cpp 与端侧模型工具链继续扩张,隐私、低延迟和离线能力成为关键卖点。',
      source: 'GitHub News',
      url: 'https://github.com',
      permalink: 'https://github.com',
      publishedAt: _now,
    ...
    AiNewsItem(
      ...
      summary:
          '蒸馏与量化让 7B 级别模型在消费级硬件上可用,端侧智能体开始进入真实产品。',
      source: 'GitHub News',
      url: 'https://github.com',
      permalink: 'https://github.com',
      publishedAt: _now,
    ...
    AiNewsItem(
      ...
      summary:
          '团队接入多模型后,模型路由、成本观测和评测流水线成为新的工程基础设施。',
      source: 'GitHub News',
      url: 'https://github.com',
      permalink: 'https://github.com',
      publishedAt: _now,
