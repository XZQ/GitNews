...
const List<String> githubMonitorDefaultRepos = ['openai/codex', 'modelcontextprotocol/servers', 'langchain-ai/langgraph', 'anthropics/claude-code', 'ollama/ollama', 'vllm-project/vllm'];
