...
class _GitHubTokenCard extends ConsumerStatefulWidget {
  const _GitHubTokenCard();

  @override
  ConsumerState<_GitHubTokenCard> createState() => _GitHubTokenCardState();
}

class _GitHubTokenCardState extends ConsumerState<_GitHubTokenCard> {
