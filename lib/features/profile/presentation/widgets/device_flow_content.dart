  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        SelectableText(
          code,
          style: AppTypography.headlineMedium.copyWith(letterSpacing: 4, color: colors.primary, fontWeight: FontWeight.w700),
        ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(onPressed: () => _copy(context, code), icon: const Icon(Icons.copy_rounded, size: 18), label: Text(l10n.tr('device_flow.copy_code'))),
            ),
