      ...
      child: Column(
        ...
        children: [
          ...
          ProfileSettingRow(
            ...
            trailing: const ThemeModePreference(),
          ),
          ProfileSettingRow(
            icon: Icons.translate_outlined,
            label: l10n.tr('app.language'),
            trailing: const LanguagePreference(),
          ),
          ProfileSettingRow(
          ...
          ProfileSettingRow(
            ...
            trailing: const StartupTabPreference(),
          ),
          ProfileSettingRow(
            icon: Icons.cloud_outlined,
            label: l10n.tr('profile.settings.data_source'),
            trailing: const TrendingDataSourcePreference(),
          ),
          ProfileSettingRow(
            icon: Icons.open_in_new_rounded,
            label: l10n.tr('profile.link_open_mode'),
            trailing: const LinkOpenModePreference(),
          ),
          ProfileSettingRow(
            icon: Icons.code,
