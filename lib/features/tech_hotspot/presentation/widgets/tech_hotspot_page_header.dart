...
class TechHotspotPageHeader extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final digest = ref.watch(filteredTechHotspotDigestProvider).value;
    final freshness = ref.watch(techHotspotFreshnessProvider).value;
...
Future<void> _showCategoryFilterSheet(BuildContext context, WidgetRef ref) async {
  final categories = _categoryOptions(ref.read(techHotspotDigestProvider).value, AppLocalizations.of(context));
